 ...
 * @author Jimmy
 */
public class BoardCompactExtended implements Cloneable {
    ...
    private BoardCompactExtended() {
    }

    public BoardCompactExtended(int width, int height) {
    ...
    // fromBoardCompact method required to add our own board type to weblab
    public static BoardCompactExtended fromBoardCompact(BoardCompact board) {
        BoardCompactExtended result = new BoardCompactExtended();
    ...
    @Override
    public BoardCompactExtended clone() {
        BoardCompactExtended result = new BoardCompactExtended();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BoardCompactExtended)) return false;
        BoardCompactExtended other = (BoardCompactExtended) obj;
    ...
    public boolean equalsState(BoardCompactExtended other) {
